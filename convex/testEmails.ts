...
export const sendAllTemplatesTest = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    const d: Record<string, string> = {
      ...
      customerName: cust,
      parentName: cust,
      resetUrl: "https://cricketrevolution.com.au/reset-password?token=TEST123",
      verificationUrl: "https://cricketrevolution.com.au/verify?token=TEST123",
      signUpUrl: "https://cricketrevolution.com.au/signup?invite=TEST123",
      bookingUrl: "https://cricketrevolution.com.au",
      calendarUrl: "https://cricketrevolution.com.au",
      amount: "$32.00",
      ...
      link: "https://cricketrevolution.com.au",
      ...
      photoUrl: "https://cricketrevolution.com.au/storage/test-photo.jpg",
      where: lane,
    };
