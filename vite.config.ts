  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        // on demand anyway.
        globIgnores: ["**/charts-*.js", "**/facility-instructions/**", "**/access/**", "**/58f7d9/**", "**/d058cb/**"],
        ...
        navigateFallbackDenylist: [/^\/api\//, /^\/reset-password/, /^\/rev-ops-7k2p/, /^\/facility-instructions/, /^\/access/, /^\/58f7d9/, /^\/d058cb/],
